...
async def generate_sql_rule(body: _GenerateSqlRuleRequest):
    ...
    system_prompt = (
        ...
        "MinDate and MaxDate are TEXT strings ('YYYY-MM'). Do NOT use EXTRACT or date functions.\n"
        ...
        "  → condition: Units != '[]'\n\n"
        "  'percent values should not exceed 100'\n"
        "  → query: SELECT StatVar, MaxValue FROM stats   (do NOT filter by Units contents)\n"
