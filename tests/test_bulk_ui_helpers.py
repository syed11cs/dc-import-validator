...
class TestIndexHtmlBulkUiContract(unittest.TestCase):
    ...
    def test_bulk_dashboard_ux_polish_contract(self) -> None:
        ...
        self.assertIn("bulk-report-btn--pending", self.html)
        self.assertIn("Preparing…", self.html)
        ...
        self.assertIn("Batch job status", self.html)
        ...
        self.assertIn("Bulk discovery completed", self.html)
        ...
        self.assertIn("setBulkRunButtonBusy", self.html)
